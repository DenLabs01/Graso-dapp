  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden px-4 pt-12 pb-12 md:min-h-[90vh] md:pt-0">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #a78bfa 0%, #93c5fd 50%, #a7f3d0 100%)",
          opacity: 0.3,
        }}
      />

      {/* Hero Content - Centered Text - MADE BIGGER */}
      ...
      <div className="relative mx-auto mt-10 md:mt-12 h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] max-w-full md:max-w-4xl">
        {/* Central Property - STREAM (BIGGER) */}
        <div className="absolute left-1/2 top-1/2 z-20 h-[200px] w-[200px] sm:h-[240px] sm:w-[240px] md:h-[280px] md:w-[280px] lg:h-[320px] lg:w-[320px] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-xl md:rounded-2xl border-[10px] md:border-[15px] lg:border-[20px] border-black ">
          <Image
            src="/hero-section/stream-hero-img.svg"
            alt="Stream Property"
            fill
            ...
            priority
          />
          <div className="absolute bottom-0 left-0 right-0 bg-black border-[5px] sm:border-[8px] md:border-[12px] lg:border-[20px] border-black py-1 md:py-1.5 text-center font-syne text-xs sm:text-sm font-bold text-white">
            Stream
        ...
        {isMobile ? (
          ...
          <>
            {/* HOLA - Left side (MOVED UP AND MORE LEFT) */}
            ...
            {/* JOS ESTATE - Right side (MOVED UP AND MORE RIGHT) */}
