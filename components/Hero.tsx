...
export default function Hero() {
    return (
        <section
            className="relative w-full min-h-screen px-4 md:px-8 lg:px-16 bg-[url('/hero-section/bg.svg')] bg-cover bg-no-repeat"
        >
            <div className="max-w-7xl mx-auto pt-12 md:pt-20 pb-8 md:pb-16">
                ...
                <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16 px-4">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[64px] font-bold mb-4 md:mb-6 font-montserrat text-black">
                        Making Real Estate More Accessible to All
                    </h1>
                    <p className="text-base md:text-lg text-black mb-6 md:mb-8 max-w-3xl mx-auto font-dm-sans">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 font-dm-sans">
                        <Link
                            href="#"
